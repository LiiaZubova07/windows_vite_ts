...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  var headers = document.querySelector(headerSelector);
  ...
  hideTabContent();
  showTabContent(); //отследить какой таб кликнул пользователь

  headers.addEventListener('click', function (e) {
    var target = e.target; //точно ли пользователь кликнул туда, куда надо
